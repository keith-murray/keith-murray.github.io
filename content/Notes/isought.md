...
My argument was that neuroscience is ill-positioned to advance AI because an algorithm’s similarity to the brain does not cause that algorithm to experience success in AI; an algorithm’s power and efficiency dictate its success and it’s these qualities that might explain why the brain implements that algorithm. 
...
> P3: The brain uses powerful algorithms.\
> P4: Algorithm $x$ is like the brain.\
> \-----------------------------------------------------------------\
> C2: Algorithm $x$ ought to be a powerful algorithm.[^2]
...
Our logic above assumes that ‘chairs’ are sufficient for flight. Regarding our NeuroAI argument, we assume that ‘being brain-like’ is sufficient for being ‘a powerful algorithm’. Indeed, while algorithms 'being brain-like' could be correlated with ‘being powerful’, our RNN example shows that this correlation is not causal.
...
> P8: The brain uses powerful algorithms.\
> P9: Algorithm $x$ is a powerful algorithm.\
> \--------------------------\
...
> P12: Algorithm $x$ efficiently represents uncertainty.\
> \--------------------------\
...
The remedy to NeuroAI’s problem could be for researchers to appeal to **first principles**, like P11. Now, instead of understanding implementation-level details of the brain, the bulk of NeuroAI could concern articulating and evaluating what the first principles of intelligence are. This, I assume, is highly nontrivial.
